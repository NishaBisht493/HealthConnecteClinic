    ...
    <table class="table table-hover table-bordered">
        ...
        <tbody>
            ...
            <tr align = "center">
                ...
                <td>{{$appointments->appDate}}</td>
                <td>{{$appointments->appTime}}</td>
                <td>{{$appointments->status}}</td>
                <td><a href="{{url('cancel_appointment', $appointments->id)}}" onclick = "return confirm('Do you really want to cancel this appointment?')" class = "btn btn-sm btn-outline-danger">Cancel</a></td>
            </tr>
            @endforeach
        </tbody>
