...
<div class="page-hero bg-image overlay-dark" style="background-image: url(../assets/img/body.jpg);">
<div class="hero-section">
    <div class="container text-center wow zoomIn">
    <span class="subhead">We Care For You</span>
    <h1 class="display-4">Live Easy</h1>
    <a href="{{url('consult')}}" class="btn btn-warning">Let's Consult</a>
    </div>
</div>
</div>
...
<div class="page-section py-3 mt-md-n5 custom-index">
    ...
    <div class="row justify-content-center">
        ...
        <div class="card-service wow fadeInUp">
            ...
            <p><span>Contact</span> a doctor</p>
        </div>
        </div>
        <div class="col-md-4 py-3 py-md-0">
        <div class="card-service wow fadeInUp">
...
<div class="container">
    ...
    <p id="copyright">Copyright &copy; 2023 <a href="https://macodeid.com/" target="_blank">onlinehealthconnect</a>. All right reserved</p>
</div>
</footer>
